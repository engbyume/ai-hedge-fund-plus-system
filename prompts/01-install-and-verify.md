...
Use the public links in integrations/tools.md. The relevant optional components are Chronos, TimesFM, Kronos, yfinance, and a CI or scheduler integration. Do not download private skills, arbitrary code, model weights, cookies, credentials, or account exports. Do not use a third-party repository as a source of truth when its license or compatibility is unclear.
